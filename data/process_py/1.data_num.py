#这个代码是从最原始的数据集中随机抽取数据并且重新保存为新文件，也即得到2000+数据
...
if __name__ == "__main__":
    # 执行抽取
    extract_cases("PMC-Patients-V2.json", "PMC2500.jsonl",k=2500)
    # extract_cases("data/process_document/MTMedDialog_test.json", "data/process_document/MTMed2082.jsonl",k=2082)