...
def generate_prompt(index, case_json):
    ...
    3. **Diagnosis Rule**:
       ...
       - Secondary Source: Analyze the Patient History in the input.
    ...
    - **Diagnosis**: The clinical diagnosis assigned to the patient.
...
if __name__ == "__main__":
    # 在这里统一配置所有参数
    CONFIG = {
        "input_file": "process_document/PMC2500.jsonl",
        "output_file": "new700_PMC.json",
